...
X_Y - А реализуется как В в позиции между Х и Y<\br>
#_  - А реализуется как В в позиции начала слова<\br>
_# - А реализуется как В в позиции конца слова<\br>
_Y - А реализуется как В  в позиции перед Y<\br>
X_ - А реализуется как В в позиции после X<\br>
 - А реализуется как В в любой позиции<\br>
X_Y - А выпадает в позиции между Х и Y<\br>
_* - А реализуется как В в позиции перед ударным гласным<\br>
@_ - А реализуется как В в позиции перед гласным<\br>
&_& - А реализуется как В в позиции между двумя согласными<\br>
